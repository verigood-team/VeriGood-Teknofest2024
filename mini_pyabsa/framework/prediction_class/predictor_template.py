...
from mini_pyabsa.utils.text_utils.mlm import get_mlm_and_tokenizer
import mini_pyabsa.framework.flag_class.flag_template as flag
...
class InferenceModel:
    ...
    def __init__(self, checkpoint: Union[str, object] = None, config=None, **kwargs):
        ...
        """
        from mini_pyabsa.framework.checkpoint_class.checkpoint_template import (
            CheckpointManager,
        )
    ...
    def cpu(self):
        ...
        """
        self.config.device = flag.DeviceTypeOption.CPU
        self.model.to(flag.DeviceTypeOption.CPU)
        if hasattr(self, "MLM"):
            self.MLM.to(flag.DeviceTypeOption.CPU)
