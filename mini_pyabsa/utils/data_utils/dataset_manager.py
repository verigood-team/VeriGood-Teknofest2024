...
from mini_pyabsa.augmentation.apc_augment.apc_augment import auto_aspect_sentiment_classification_augmentation
from mini_pyabsa.augmentation.text_augment.tc_augment import auto_classification_augmentation

from mini_pyabsa.framework.flag_class.flag_template import (
    TaskCodeOption,
    PyABSAMaterialHostAddress,
    TaskNameOption,
)
from mini_pyabsa.utils.check_utils.dataset_version_check import check_datasets_version
        ...
        if not os.path.exists(d):
            ...
            if load_aug:
                ...
                if not any(["augment" in x for x in dataset_file["train"]]):
                    from mini_pyabsa.utils.absa_utils.absa_utils import (
